...
/*
 * Benevolent Loader main entry function
 * Usage:
...
/* 
 * Initialize Hell's Gate table structure
 * 
 * @param Table: Pointer to the table structure to fill
 * 
 * @returns: TRUE/FALSE if the initialization succeeded/failed
 */
